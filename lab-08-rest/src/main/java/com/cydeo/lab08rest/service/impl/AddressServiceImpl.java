...
public class AddressServiceImpl implements AddressService {
    ...
    @Override
    public List<AddressDTO> retrieveAll() {
    ...
    @Override
    public List<AddressDTO> retrieveByStartsWith(String address) {
    ...
    @Override
    public List<AddressDTO> retrieveByCustomerIdAndName(Long customerId, String name) {
